...
from config import DUNE_API_KEY, QUERY_IDS, CUSTOM_QUERIES, ALL_TRACKED_VAULTS
...
def generate_sample_data():
    ...
    for vault in ALL_TRACKED_VAULTS:
        rows = []
        # Bluechip vaults have higher total assets and liquidity %
        ...
        for day_offset in range(14):  # 14 days of hourly data
